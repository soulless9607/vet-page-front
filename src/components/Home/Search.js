...
const Search = () => {
    return (
        <div class="side-menu__block active">
            ...
            <div class="side-menu__block-inner">
                ...
                <div class="side-menu__top-introduce">
                    <a href="index.html" rel="home" class="main-logo">
                        <img src="assets/images/logo/logo-header@2x.png" alt="images" />
                    </a>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis sint
                        doloribus
                        similique molestias necessitatibus blanditiis, reprehenderit dignissimos,
                        dolorem
                        commodi facilis ad temporibus ullam ipsum perferendis. Odio dolorem atque
                        ratione
                        deserunt?
                    </p>
                    <hr />
